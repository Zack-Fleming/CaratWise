...
The models we will be comparing are K-means, SVM,logistic regression, linear regression, and Random forest. We will then compare the accuracy of the models, to see if any model performs within the target performance of our main goal.
...
# Tweak the model's features based on what we learned 
linearModel4 <- lm(price ~ carat + cut + table, train)
